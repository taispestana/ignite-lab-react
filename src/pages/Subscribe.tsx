...
export function Subscribe() {
  ...
  return (
    <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex-col items-center">
      <div className="w-full max-w-[1100px] flex items-center justify-between at-20 mx-auto">
        <div className="max-m-[640px]">
          <Logo />
        ...
        <div className="p-8 bg-gray-700 border border-gray-500 tounded">
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-4 bg-gray-500 uppercase py-4 rounded font-bold text-sm hover:bg-green-700 transition-colors disabled:oppacity-50"
            >
              Garantir minha vaga
            </button>
          </form>
